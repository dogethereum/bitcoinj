...
public class PartialMerkleTreeTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(PartialMerkleTreeTest.class);
    ...
    public static void beforeAll() throws Exception {
        ...
        allHashes.put("01", PartialMerkleTree.combineLeftRight(allHashes.get("0").getBytes(), allHashes.get("1").getBytes()));
        allHashes.put("23", PartialMerkleTree.combineLeftRight(allHashes.get("2").getBytes(), allHashes.get("3").getBytes()));
        allHashes.put("45", PartialMerkleTree.combineLeftRight(allHashes.get("4").getBytes(), allHashes.get("5").getBytes()));
        allHashes.put("67", PartialMerkleTree.combineLeftRight(allHashes.get("6").getBytes(), allHashes.get("7").getBytes()));

        allHashes.put("0123",PartialMerkleTree.combineLeftRight(allHashes.get("01").getBytes(), allHashes.get("23").getBytes()));
        allHashes.put("4567",PartialMerkleTree.combineLeftRight(allHashes.get("45").getBytes(), allHashes.get("67").getBytes()));

        allHashes.put("01234567",PartialMerkleTree.combineLeftRight(allHashes.get("0123").getBytes(), allHashes.get("4567").getBytes()));

        allHashes.put("88",PartialMerkleTree.combineLeftRight(allHashes.get("8").getBytes(), allHashes.get("8").getBytes()));
        allHashes.put("8888",PartialMerkleTree.combineLeftRight(allHashes.get("88").getBytes(), allHashes.get("88").getBytes()));
        allHashes.put("88888888",PartialMerkleTree.combineLeftRight(allHashes.get("8888").getBytes(), allHashes.get("8888").getBytes()));
    ...
    public void test1() throws Exception {
        ...
        byte[] includeBits = Hex.decode("FF");
        PartialMerkleTree pmt = PartialMerkleTree.buildFromLeaves(params, includeBits, hashList);
    ...
    public void test2() throws Exception {
        ...
        byte[] includeBits = Hex.decode("0F");
        PartialMerkleTree pmt = PartialMerkleTree.buildFromLeaves(params, includeBits, hashList);
        for (int i = 0; i < 4; i++) {
            assertEquals(i, pmt.getTransactionIndex(hashList.get(i)));
        }
    ...
    public void test2b() throws Exception {
        ...
        byte[] includeBits = Hex.decode("81");
        PartialMerkleTree pmt = PartialMerkleTree.buildFromLeaves(params, includeBits, hashList);
        for (int i = 1; i < 7; i++) {
            try {
                pmt.getTransactionIndex(hashList.get(i));
    ...
    public void test3() throws Exception {
        ...
        byte[] includeBits = Hex.decode("FF01");
        PartialMerkleTree pmt = PartialMerkleTree.buildFromLeaves(params, includeBits, hashList);
        for (int i = 0; i < 9; i++) {
            assertEquals(i, pmt.getTransactionIndex(hashList.get(i)));
        }
